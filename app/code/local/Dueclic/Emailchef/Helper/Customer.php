...
class Dueclic_Emailchef_Helper_Customer extends Mage_Core_Helper_Abstract
{
    ...
    public function getTotal2Ordered($customer_id, $withAdd = true){
    ...
    public
    function getCustomersData($action = "no", $storeIds = array())
    {
        $model = Mage::getModel("customer/customer");
    ...
    public
    function getSyncOrderData($order)
    {
